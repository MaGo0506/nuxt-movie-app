...
export default {
  ...
  methods: {
    async getMovies() {
      const data = axios.get('https://api.themoviedb.org/3/movie/now_playing?api_key=ba7f48d120906a59bb4c8fccc134ff75&language=en-US&page=1')
    ...
    async searchMovies() {
      const data = axios.get(
        `https://api.themoviedb.org/3/search/movie?api_key=ba7f48d120906a59bb4c8fccc134ff75&language=en-US&page=1&query=${this.searchInput}`
      )
      const response = await data;
      response.data.results.forEach(movie => {
